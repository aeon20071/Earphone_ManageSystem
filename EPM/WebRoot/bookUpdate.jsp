	...
	<head>
		...
		<style>
			@import url(http://fonts.googleapis.com/css?family=Arimo);
					...
					#bookUpdateOK_data_way001{margin: 10px 7px 0 0;font-weight: normal;}
					#bookUpdateOK_data_way002{margin: 10px 7px 0 25px;font-weight: normal;}
					#bookUpdateOK_data_way003{margin: 10px 7px 0 25px;font-weight: normal;}
					#bookUpdateOK_data_way004{margin: 10px 7px 0 25px;font-weight: normal;}
					
					#bookUpdateOK_data_type001{margin: 10px 7px 0 0;font-weight: normal;}
					#bookUpdateOK_data_type002{margin: 10px 4px 0 15px;font-weight: normal;}
					#bookUpdateOK_data_type003{margin: 10px 7px 0 15px;font-weight: normal;}
					
					#bookUpdateOK_data_microTrue{margin: 10px 7px 0 0;font-weight: normal;}
					#bookUpdateOK_data_microFalse{margin: 10px 7px 0 15px;font-weight: normal;}
		...
		<div class="main-content main-content-checkout">
			<div class="container">
				...
				<h3 class="custom_blog_title">
					更新耳机信息 Updata Earphone Information
				</h3>
				<div class="checkout-wrapp">
					<s:form action="bookUpdateOK" method="post" theme="simple" enctype="multipart/form-data">
								...
								<div class="row-col-1 row-col">
									<div class="shipping-address">
										...
										<p class="form-row forn-row-col forn-row-col-1">
											...
											<s:select list="#{'001':'专业监听耳机','002':'降噪耳机','003':'运动耳机','004':'真无线耳机'}" name="data.purpose" title="state"
											 data-placeholder="London" class="chosen-select" tabindex="1"></s:select>
										</p>
										<p class="form-row forn-row-col forn-row-col-2">
											<label class="text">发声原理</label>
											<s:select list="#{'True':'动铁耳机','False':'动圈耳机'}" name="data.vp" title="state" data-placeholder="London"
											 class="chosen-select" tabindex="1"></s:select>
										</p>
										...
										<p class="form-row form-row-number">
											...
											<s:radio list="#{'001':'蓝牙','002':'NFC','003':'3.5mm接口','004':'Type-C接口'}" name="data.way" />
										</p>

										<p class="form-row form-row-last">
											<label class="text">麦克风</label>
											<s:radio list="#{'True':'有','False':'无'}" name="data.micro" />
										</p>

										<p class="form-row form-row-first">
											<label class="text">佩戴方式</label>
											<s:radio list="#{'001':'头戴式','002':'入耳式','003':'耳挂式'}" name="data.type" />
										</p>
									...
									<div class="your-order">
										...
										<ul class="list-product-order">
											<li class="product-item-order">
												...
												<s:textarea style="height: 248px;" name="data.comment"></s:textarea>
											</li>
											<li class="product-item-order">
